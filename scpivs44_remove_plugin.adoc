...
. 로 이동합니다 `/etc/vmware/vsphere-ui/vc-packages/vsphere-client-serenity/com.netapp.scvm.webclient-4.5.0.5942045/plugins` vCenter Server의 픽업 폴더에서 다음 파일을 수동으로 삭제합니다.
+
