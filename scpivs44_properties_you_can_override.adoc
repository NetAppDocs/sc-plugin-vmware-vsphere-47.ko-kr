...
+
VMware vSphere 및 SnapCenter용 SnapCenter 플러그인과 에 나열된 추가 암호 해제 장치 간의 통신 채널에 대해 다음 약함을 비활성화합니다 `include.weakCiphers`AES_256_CBC_SHA256 TLS_SHA256 TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 TLS_RSA_WITH_AES_128_128_CBC_SHA256_TLS_DHE_RSA_WITH_AES_128_SHA256_RSA_GCM_RSA_AES_256_RSA_RSA_RSA_AES_A384 포함_AES_SHA256_SHA256_SHA256_RSA_RSA_GCM_RSA_RSA_RSA_RSA_RSA_SE_RSA_RSA_RSA_RSA_RSA_RSA_RSA_SE_SE_SE_RSA_RSA_SE_SE_SE_RSA_SE_SE_
